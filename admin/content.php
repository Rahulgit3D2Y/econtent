...
$date=date("Y-m-d h:i:sa");
    if(isset($AddContent))
{
     $rs=mysqli_query($con,"SELECT * FROM `content` WHERE `content_name`='$contentname'");
...
} else
{
        ...
        mysqli_query($con,"INSERT INTO `content`(`content_name`,`content_status`, `content_createdby`, `content_createdtime`) VALUES ('$contentname','$contentnamestatus','$log','$date')");
  ...
  <div class="modal-dialog modal-xl">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5 class="modal-title" id="addcontentmodelnameLabel">Add Content Name</h5>
 ...
 <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                &nbsp;<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addcontentmodelname"> <span class="fas fa-plus-circle"></span> Add Content Name</button>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimpl">
                                    ...
                                    <tbody>
                                        ...
                                        $count = 0;
                                        $sql=mysqli_query($con,"SELECT * FROM `content` WHERE `content_status`='Active'");
                                        while($result=mysqli_fetch_assoc($sql))
    {
        $count+=1;
   $id=$result['content_id'];     
$created_user_id=$result['content_createdby'];
$updated_user_id=$result['content_updateby'];
        ...
        $row1=mysqli_fetch_array($result12);
         $upadted_user_login_name=$row1['first_name']." ".$row1['middle_name']." ".$row1['last_name'];
                                        ...
                                        <tr>        
                                            ...
                                            <td><a href="menu_update.php?menu_id=<?php echo $id;?>" onclick="return confirm('Do you really want to Update <?php echo $result['content_name'] ?>?');"><span class='fas fa-edit'></span></a></td>
                                    <td><a href="menu_delete.php?menu_id=<?php echo $id;?>"onclick="return confirm('Do you really want to Delete <?php echo $result['content_name'] ?>?');"><span class='fas fa-trash'></span></a></td> 
