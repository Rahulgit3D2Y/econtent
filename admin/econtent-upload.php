...
exit();
  ...
  $econtentuploadquery="INSERT INTO `econtent_message`(`econtent_message_content_id`, `econtent_message_subcontent_id`,`econtent_message_tittle`, `econtent_message_content`, `econtent_message_image`, `econtent_message_coverphoto`, `econtent_message_contenttype`, `econtent_message_amount`, `econtent_message_status`, `econtent_message_createdby`, `econtent_message_createdtime`) VALUES ('$InputSelectContent','$InputSubContentSelect','$InputContentTittle','$InputContentMessage','$InputContentImage','$InputContentCoverPage','$InputContentType','$InputContentAmount','$status','$log','$date')";
...
<script type="text/javascript">
  function  InputChangeContentType() {
    ...
    jselectedcontenttype = document.querySelector('#InputContentType').value;
        if(jselectedcontenttype == "Premiun") {
        ...
        } else if(jselectedcontenttype == "Non Premiun") {
    ...
    <?php
          ...
          <option selected="selected" disabled selected>-- Select an option --</option>
                                           ...
                                           <div class="row mb-3">
                                               ...
                                               <div class="col-md-12">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <textarea class="form-control" required id="InputContentMessage" name="InputContentMessage" required="InputContentMessage"></textarea>
                                             ...
                                             <div class="row mb-3">
                                               ...
                                               <div class="col-md-3">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" type="file" name="InputContentImage" id="InputContentImage" accept="*/jpg">
                                                        <label for="InputContentImage">Image</label>
                                                    </div>
                                                </div>
                                                 <div class="col-md-3">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" type="file" name="InputContentCoverPage" id="InputContentCoverPage" accept="*/jpg">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <select class="form-select"  name="InputContentType" id="InputContentType" onchange="InputChangeContentType()" required>
                                                            <option selected="selected" disabled selected>-- Select an option --</option>
                                                            <option id="Non Premiun">Non Premiun</option>
                                                            <option id="Premiun">Premiun</option>
                                                        </select>
